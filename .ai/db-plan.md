...
1. **SELECT (Public):**
   ...
   - _Uwaga:_ W MVP można uprościć do "zezwól na odczyt wszystkiego", chyba że chcemy ukryć `verification_doc_path` (dokumentacja powinna być chroniona na poziomie Storage).
2. **UPDATE (Owner):**
